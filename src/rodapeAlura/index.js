    ...
    pegaDadosDaAlura.addEventListener('load', function escutaRequest() {
        ...
        document.querySelector('#rodape-preview-container').innerHTML = `
            <div class="cfg___categories">
                <h2 style="border-bottom: 1px solid #e2f0ff; margin: 0; text-align: center; padding: 25px; font-size: 25px; color: #525c65;">Conheça a Alura</h2> <div class="cfg___container">
